...
struct Mouse {
    ...
    DistanceMeasurement left_dist_measure{PINS::IR_LED_1, PINS::IR_1, 2610.3, -0.532};
    DistanceMeasurement frontleft_dist_measure{PINS::IR_LED_2, PINS::IR_2, 2987.2, -0.55};
    DistanceMeasurement frontright_dist_measure{PINS::IR_LED_3, PINS::IR_3, 2935.7, -0.539};
    DistanceMeasurement right_dist_measure{PINS::IR_LED_4, PINS::IR_4, 1390.7, -0.457};
