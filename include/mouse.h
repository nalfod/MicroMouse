...
struct Mouse {
    ...
    // TODO these could be combined into a new, distance measure class!
    LED ir_led_left{PINS::IR_LED_1};
    LED ir_led_frontleft{PINS::IR_LED_2}; 
    LED ir_led_frontright{PINS::IR_LED_3};
    LED ir_led_right{PINS::IR_LED_4};
